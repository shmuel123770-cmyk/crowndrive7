...
export function home() {
  ...
  <section class="info-section fleet-zone reveal"><div class="sec-head"><p class="eyebrow">הצי שלנו</p><h2>רכבים זמינים</h2><p class="sec-sub">כל רכב עם תיעוד מלא ודירוגים אמיתיים.</p></div>${carGrid(featuredFirst(available).slice(0, 9))}<div class="see-all"><button class="btn primary see-all-btn" data-route="cars">כל הרכבים באתר ←</button></div></section>
